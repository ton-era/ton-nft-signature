...
Test usage:
>  cd src
>  python3 -m tests.integration.04_provider_change_owner 1 provider_address [new_owner_address]
wait...
>  python3 -m tests.integration.04_provider_change_owner 0 provider_address [new_owner_address]
...
if __name__ == '__main__':
    ...
    result = provider.change_owner(
        op_amount=0.011, new_owner_address=new_owner_address,
