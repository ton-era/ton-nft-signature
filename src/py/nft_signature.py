...
class NFTSignature(Contract):
    code = ''
    ...
    def get_info(self, results):
        payload = None
        has_payload = int(results[6][1], 16) == -1
        if has_payload:
            raw_payload = base64.b64decode(results[7][1]['object']['data']['b64']).decode('utf-8')
